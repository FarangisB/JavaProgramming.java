...
public class PolymorphismPractice {
    ...
    public static void main(String[] args) {
        ...
        for (Car eachCar : cars){
            if(eachCar instanceof Toyota){
                if(eachCar.getYear()>=2010&&eachCar.getYear()<=2011){
                    System.out.println(eachCar.getBrand()+" "+ eachCar.getModel()+" = "+eachCar.getYear());
                }
            }
            if(eachCar instanceof BMW){
                if(eachCar.getYear()>=1929&&eachCar.getYear()<=2022){
                    System.out.println(eachCar.getBrand()+" "+ eachCar.getModel()+" = "+eachCar.getYear());
                }
            }
        ...
        for (Car eachCar : cars){
            if(eachCar.getMiles()>carWithHighestMileage.getMiles()){
                carWithHighestMileage=eachCar;
            }
            if(eachCar.getMiles()<carWithLowestMileage.getMiles()){
