...
import day43_Abstraction_ExceptionsRecap.PersonTask.Developer;
import day43_Abstraction_ExceptionsRecap.PersonTask.Employee;
import day43_Abstraction_ExceptionsRecap.PersonTask.Tester;
...
public class PolymorphismPractice2 {
    ...
    public static void main(String[] args) {
        ...
        for (Employee scrumMember : scrumMembers) {
            scrumTeam += scrumMember.getName()+"-"+scrumMember.getJobTitle()+", ";
        }
        System.out.println("Scrum ipTeam = " + scrumTeam);
