...
public class Student {
    ...
    public String toString() {
        return "day36_InheritanceIntro.Incapsulation.Student{" +
                "name='" + name + '\'' +
                ", gender=" + gender +
                ", age=" + age +
                ", studentID=" + studentID +
...
/*
day36_InheritanceIntro.Incapsulation.Student Task:
		1. Create a class called day36_InheritanceIntro.Incapsulation.Student:
				Attributes:
